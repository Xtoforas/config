"------------------------------------------------------------------------------
" File:     $HOME/.vimrc
" Author:   Chris Olekas <colekas@gigpeak.com>
"
...
set shortmess+=raIoOtT   " Abbreviation of messages (avoids 'hit enter ...').
...
"" remember info for 100 files, but never any on removable disks, don't remember
"" marks in files, don't rehighlight old search patterns, and only save up to
"" 500 lines of registers; including @100 in there should restrict input buffer
